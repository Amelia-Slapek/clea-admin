...
export const AccountPage = () => {
    ...
    const handleAvatarChange = async (e) => {
        ...
        if (file.size > maxSize) {
            setError('Zdjęcie jest zbyt duże. Maksymalny rozmiar to 5MB');
            return;
        }
    ...
    const validateForm = () => {
        ...
        if (changePassword) {
            if (!passwordData.currentPassword) {
                setError('Bieżące hasło jest wymagane do zatwierdzenia zmian');
                return false;
            }
    ...
    const handleSubmit = async (e) => {
        ...
        if (!token) {
            setError('Błąd autoryzacji: brak tokena. Zaloguj się ponownie.');
            setLoading(false);
            return;
        }
                                ...
                                <div className="profile-account__avatar-section">
                                    ...
                                    <div className="profile-account__avatar-actions">
                                        ...
                                        <button
                                            ...
                                            disabled={!avatarPreview || user?.avatarImageId === DEFAULT_AVATAR_ID_STRING}
                                        >
                                            Usuń zdjęcie
                                        </button>
                                    </div>
                                            ...
                                            <div className="profile-account__field">
                                                ...
                                                <div className="profile-account__input-wrapper">
                                                    ...
                                                    >
                                                        <img
                                                            src={eyeIcon}
                                                            alt={showCurrentPassword ? "Ukryj hasło" : "Pokaż hasło"}
                                                            style={{ opacity: showCurrentPassword ? 1 : 0.5 }}
                                                        />
                                                    </button>
                                                </div>
                                            </div>
